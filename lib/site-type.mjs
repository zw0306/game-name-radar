...
const WIKI_SOURCE_IDS = new Set(['steam-top-wishlist', 'steam-popular-new', 'steam-latest-indie']);
const WIKI_KINDS = new Set(['steam-top-wishlist', 'steam-popular-new', 'steam-new']);
